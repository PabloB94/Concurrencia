...
class CC_03_MutexEA {
    ...
    volatile static boolean quiere_inc;
    volatile static boolean quiere_dec;
    volatile static int turno = 0;
    //Usamos turno 0 para el incrementador y turno 1 para el decrementador
